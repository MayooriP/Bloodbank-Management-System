...
<section class="my-5" id="contact">
  ...
  <div>
  <p class="text-center bg-dark text-white">AJ Institute of Engineering and Technology<br> Mail : <a style="text-decoration:none;color:white;" href="mailto: ajenggcollege@gmail.com" >ajenggcollege@gmail.com</a><br> Phone number : <a style="text-decoration:none;color:white;" >+ 91 (824) 286 2200</a></p>
