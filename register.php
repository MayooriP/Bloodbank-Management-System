        ...
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center bg-light" style="padding: 20px">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#admins">admin</a>
              </li>
            </ul>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container active" id="hospitals">
        ...
        <form action="file/hospitalReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="password" name="hpassword" placeholder="Hospital Password" class="form-control mb-3"  required pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="tel" name="rphone" placeholder="User Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Phone number must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
      ...
      <div class="tab-pane container fade" id="admins">
        ...
        <form action="file/adminReg.php" method="post" enctype="multipart/form-data">
          <input type="text" name="aname" placeholder="User Name" class="form-control mb-3" required>
         <input type="text" name="acity" placeholder="User City" class="form-control mb-3" required>
         <input type="tel" name="aphone" placeholder="User Phone Number" class="form-control mb-3" required pattern="[0,6-9]{1}[0-9]{9,11}" title="Phone number must have start from 0,6,7,8 or 9 and must have 10 to 12 digit">
         <input type="email" name="aemail" placeholder="User Email" class="form-control mb-3" required>
         <input type="password" name="apassword" placeholder="User Password" class="form-control mb-3" required minlength="6">
