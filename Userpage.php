    ...
    <span class="carousel-control-prev-icon"></span>
      ...
      <nav class="navbar">
        ...
        <ul class="nav-list">
         ...
         <!-- </li>
           <li class="nav-item">
           <a href="sentrequesttest.php" class="nav-link">Status of your Blood request</a>
          </li>  -->
           ...
           <li class="nav-item">
            <a href="donor11.php" class="nav-link">donor registration</a>
          </li>
          <li class="nav-item">
            <a href="donortest.php" class="nav-link">donors list</a>
          </li>
          <li class="nav-item">
